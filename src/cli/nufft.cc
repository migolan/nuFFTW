...
int main(int argc, char* argv[])
{
	if (strcmp(argv[1],"-h") == 0) {
		nuFFT_print("nufft_<typename> Nthreads direction imagefilename kdatafilename Ndim imagesize maxerr_power alpha resamplingmethod trajfilename\n");
		nuFFT_print("nufft_<typename> Nthreads direction imagefilename kdatafilename impfilename\n");
		return 0;
	}
