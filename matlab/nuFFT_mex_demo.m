...
% This demo explains how to use the mex interface of the nuFFT.
...
% * |imagenudft| - exact non-uniform FT of the k-space samples, onto a
...
%% Forward nuFFT
kdata_dc2 = nuFFT_imp.forward(1, imagenufft);

%% Check if the forward and adjoint transforms are compatible
kdata_dc2'*kdata_dc-imagenufft(:)'*imagenufft(:)
%%
...
%%
imagenufft2 = nuFFT_imp2.adjoint(1,kdata_dc);
%%
e = get_image_errors(imagenudft,imagenufft2);
%%
